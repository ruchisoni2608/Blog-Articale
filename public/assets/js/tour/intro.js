...
(function (root, factory) {
    ...
    function _introForElement(targetElm) {
        ...
        if (this._options.steps) {
            ...
            for (
                ...
                if (
                    ...
                    if (floatingElementQuery == null) {
                        ...
                        floatingElementQuery.className =
                            "introjsFloatingElement";
                ...
                currentItem.scrollTo =
                    currentItem.scrollTo || this._options.scrollTo;
            ...
            for (
                ...
                if (
                    typeof currentElement.getAttribute(
                ...
                if (step > 0) {
                    introItems[step - 1] = {
                        ...
                        tooltipClass:
                            currentElement.getAttribute("data-tooltipClass"),
        ...
        if (_addOverlayLayer.call(self, targetElm)) {
            ...
            self._onKeyDown = function (e) {
                if (e.keyCode === 27 && self._options.exitOnEsc == true) {
                    ...
                    if (
                        target &&
                        target.className.indexOf("introjs-prevbutton") > 0
                    ) {
    ...
    function _showElement(targetElement) {
        ...
        if (oldHelperLayer != null) {
            var oldHelperNumberLayer = oldReferenceLayer.querySelector(
                ...
                oldArrowLayer =
                    oldReferenceLayer.querySelector(".introjs-arrow"),
                oldtooltipContainer =
    ...
    function _setShowElement(targetElement) {
        ...
        if (targetElement.element instanceof SVGElement) {
            ...
            while (targetElement.element.parentNode != null) {
                if (
                    !parentElm.tagName ||
                    parentElm.tagName.toLowerCase() === "body"
                )
                    break;
    ...
    function _removeHintTooltip() {
        var tooltip = this._targetElement.querySelector(
    ...
    function _populateHints(targetElm) {
        ...
        if (this._options.hints) {
            ...
            for (var i = 0, l = hints.length; i < l; i++) {
                ...
                // hint animation
                var hintAnimation =
                    currentElement.getAttribute("data-hintAnimation");
    ...
    function _alignHintPosition(position, hint, element) {
        ...
        switch (position) {
            ...
            case "middle-left":
                hint.style.left = offset.left + "px";
                hint.style.top =
                    offset.top + (offset.height - iconHeight) / 2 + "px";
                break;
            case "middle-right":
                hint.style.left = offset.left + offset.width - iconWidth + "px";
                hint.style.top =
            ...
            case "middle-middle":
                hint.style.left =
                    offset.left + (offset.width - iconWidth) / 2 + "px";
                hint.style.top =
                    offset.top + (offset.height - iconHeight) / 2 + "px";
                break;
            case "bottom-middle":
