    ...
    (t = window.Morris = {}),
                        ...
                        typeof this.options.ymax == "string"
                            ? this.options.ymax.slice(0, 4) === "auto"
                                ? this.options.ymax.length > 5
                                    ? ((this.ymax = parseInt(
                                          this.options.ymax.slice(5),
                                          10,
                                      )),
                                      h != null &&
                                          (this.ymax = Math.max(h, this.ymax)))
                        ...
                        typeof this.options.ymin == "string"
                            ? this.options.ymin.slice(0, 4) === "auto"
                                ? this.options.ymin.length > 5
                                    ? ((this.ymin = parseInt(
                                          this.options.ymin.slice(5),
                                          10,
                                      )),
                                      p != null &&
                                          (this.ymin = Math.min(p, this.ymin)))
                ...
                (r.prototype._calc = function () {
                    ...
                    if (
                        ...
                        (this.elementWidth = n),
                            ...
                            (this.right =
                                this.elementWidth - this.options.padding),
            ...
            return (
                    ...
                    return (this.paths = function () {
                        ...
                        for (
                            ...
                            (s =
                                ...
                                n.length > 1
                                    ? l.push(
                                          t.Line.createPath(n, s, this.bottom),
                                      )
                                    : l.push(null);
                        return l;
                    }.call(this));
                                    ...
                                    (r = s[n]),
                                        r._y[t] != null
                                            ? (e = this.r
                                                  ...
                                                  .attr(
                                                      "stroke-width",
                                                      this.strokeWidthForSeries(
                                                          t,
                                                      ),
                                                  )
                                                  .attr(
                                                      "stroke",
                                                      this.strokeForSeries(t),
                                                  ))
                                            : (e = null),
                ...
                (n.prototype.strokeWidthForSeries = function (e) {
                    return this.options.pointWidths[
                        e % this.options.pointWidths.length
                    ];
                }),
                    ...
                    return typeof this.options.lineColors == "function"
                        ...
                        ? this.options.pointFillColors[
                          ...
                          this.options.lineColors[
                              t % this.options.lineColors.length
                          ]
                        : this.options.lineColors[
                              t % this.options.lineColors.length
                          ];
        ...
        (t.LABEL_SPECS = {
            decade: {
                ...
                start: function (e) {
                    return new Date(
                        e.getFullYear() - (e.getFullYear() % 10),
                        0,
                        1,
                    );
                },
        ...
        (t.Area = (function (e) {
            ...
            return (
                ...
                (n.prototype.fillForSeries = function (e) {
                    ...
                    return (
                        (t = Raphael.rgb2hsl(
                            this.colorFor(this.data[e], e, "line"),
                        )),
                        Raphael.hsl(
                            t.h,
            ...
            return (
                ...
                (r.prototype.calcBars = function () {
                    ...
                    for (e = r = 0, i = s.length; r < i; e = ++r)
                        (t = s[e]),
                            (t._x =
                                this.left +
                                (this.width * (e + 0.5)) / this.data.length),
                            o.push(
                                (t._y = function () {
                                    var e, r, i, s;
                                    (i = t.y), (s = []);
                ...
                (r.prototype.drawSeries = function () {
                    ...
                    return (
                        ...
                        (u =
                            this.options.stacked != null
                                ? 1
                                : this.options.ykeys.length),
                        (e =
                            (n * this.options.barSizeRatio -
                                this.options.barGap * (u - 1)) /
                            u),
                ...
                (r.prototype.colorFor = function (e, t, n) {
                    ...
                    return typeof this.options.barColors == "function"
                        ...
                        : this.options.barColors[
                              t % this.options.barColors.length
                          ];
                }),
                ...
                (r.prototype.onHoverMove = function (e, t) {
                    ...
                    return (
                        (n = this.hitTest(e, t)),
                        (r = this.hover).update.apply(
                            r,
                            this.hoverContentForRow(n),
                        )
                    );
                }),
                ...
                (r.prototype.hoverContentForRow = function (e) {
                    ...
                    return (
                        (i =
                            this.left +
                            ((e + 0.5) * this.width) / this.data.length),
                        [t, i]
                    );
                }),
                r
