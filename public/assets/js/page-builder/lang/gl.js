...
CKEDITOR.lang["gl"] = {
    ...
    common: {
        ...
        invalidCssLength:
            "O valor especificado para o campo «%1» debe ser un número posizeta con ou sen unha unidade de medida CSS correcta (px, %, in, cm, mm, em, ex, pt, ou pc).",
        invalidHtmlLength:
            "O valor especificado para o campo «%1» debe ser un número posizeta con ou sen unha unidade de medida HTML correcta (px ou %).",
        invalidInlineStyle:
    ...
    link: {
        ...
        advanced: "Avanzado",
        advisoryContentType: "Tipo de contido informazeta",
        advisoryTitle: "Título",
        anchor: {
            toolbar: "Ancoraxe",
    ...
    table: {
        ...
        invalidCellPadding: "A marxe interior debe ser un número posizeta.",
        invalidCellSpacing: "A marxe entre celas debe ser un número posizeta.",
