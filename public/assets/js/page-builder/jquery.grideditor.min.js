        ...
        return (
            c.each(function (c, d) {
                function e() {
                    (A = d.addClass("ge-canvas")),
                        ("undefined" != typeof D && D.length) ||
                            (D = a(
                                '<textarea class="ge-html-output"/>',
                            ).insertBefore(A)),
                        (B = a('<div class="ge-mainControls" />').insertBefore(
                            D,
                        ));
                    var b = a('<div class="ge-wrapper ge-top" />').appendTo(B);
                    (C = a('<div class="ge-addRowGroup btn-group" />').appendTo(
                        b,
                    )),
                    ...
                    var c = a(
                            ...
                            .on("click", "a", function () {
                                ...
                                var d = c.find("button");
                                d.find("span").remove(),
                                    d.append(b.find("span").clone());
                            })
                            .appendTo(b),
                        e = a(
                            '<div class="btn-group float-start float-xl-end"/>',
                        ).appendTo(b),
                        h = a(
                        ...
                        i = a(
                            ...
                            .on("click", function () {
                                i.toggleClass("active btn-danger").trigger(
                                    "mouseleave",
                                );
                            })
                            .on("mouseleave", function () {
                                i.hasClass("active") ||
                                    A.addClass("ge-editing");
                            })
                            .appendTo(e),
                        j = a(window);
                        ...
                        c.forEach(function (c) {
                            var d = a('<a class="btn btn-sm btn-default" />')
                                ...
                                .attr(
                                    ...
                                    c.title
                                        ? c.title
                                        : 'Toggle "' + c.label + '" styling',
                                )
                                .toggleClass(
                                    "active btn-primary",
                                    b.hasClass(c.cssClass),
                                )
                                .on("click", function () {
                ...
                function w() {
                    return a("<div/>")
                        .addClass(
                            "ge-content ge-content-type-" + E.content_types[0],
                        )
                ...
                b.each(function () {
                    ...
                    if (!b.hasClass("active")) {
                        ...
                        var d = $.extend(
                            !0,
                            {},
                            a.summernote && a.summernote.config
                                ? a.summernote.config
                                : {},
                            {
                                tabsize: 2,
