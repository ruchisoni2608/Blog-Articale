        ...
        n = function (e, t, r) {
            if (Object.prototype.toString.call(t) === "[object Array]") {
                ...
                for (var o = 0, u = t.length; o < u; ++o) {
                    var a = i(e, t[o]);
                    if (!a && n.original)
                        return n.original.apply(window, arguments);
                    s.push(a);
                }
                r && r.apply(null, s);
            } else {
                ...
                (this.onMouseDown = function (e) {
                    ...
                    (this.focusWait = function () {
                        var e = a(
                            ...
                            t = Date.now();
                        (e > o ||
                            t - this.mousedownEvent.time > this.$focusTimout) &&
                            this.startSelect(
            ...
            function u(e) {
                function l() {
                    ...
                    if (e.$tooltipFollowsMouse) h(u);
                        ...
                        var p =
                                n.$cells[t.session.documentToScreenRow(r, 0)]
                                    .element,
                        ...
                        var s = this,
                            ...
                            a = function (e) {
                                clearInterval(l),
                                    ...
                                    (s.isMousePressed = !1),
                                    (s.$onCaptureMouseMove = s.releaseMouse =
                                        null),
        ...
        function (e, t, n) {
            ...
            function r(e) {
                e.on("click", function (t) {
                    ...
                    i &&
                        (t.getAccelKey() ? r.removeFold(i) : r.expandFold(i),
                        t.stop());
                }),
                ...
                r.implement(this, o),
                    ...
                    (this.$updateInternalDataOnChange = function (e) {
                        ...
                        if (n != 0)
                            ...
                            (n = Math.abs(
                                e.data.range.start.column -
                                    e.data.range.end.column,
                            )),
                                r.indexOf("remove") != -1 &&
                                    ((a = this.getFoldsInRange(e.data.range)),
                                    this.removeFolds(a),
                            ...
                            (f = this.getFoldLine(l, f)),
                                f
                                    ? ((a = []),
                                      ...
                                      (s[f.start.row] = this.$computeWrapSplits(
                                          a,
                                          o,
                                          i,
                                      )),
                            ...
                            if (t && t.scrollIntoView) {
                                switch (t.scrollIntoView) {
                                    ...
                                    case "selectionPart":
                                        ...
                                        (n.start.row >= r.lastRow ||
                                            n.end.row <= r.firstRow) &&
                    ...
                    (this.update = function (e) {
                        ...
                        for (;;) {
                            ...
                            a[v] && (m += a[v]),
                                f[v] && (m += f[v]),
                                this.$annotations[v] &&
                                    (m += this.$annotations[v].className),
                                p.element.className != m &&
                                    (p.element.className = m);
                            var g = t.getRowLength(v) * e.lineHeight + "px";
                            g != p.element.style.height &&
                                (p.element.style.height = g);
                            if (u) {
                                var y = u[v];
                            ...
                            if (y) {
                                ...
                                p.foldWidget &&
                                    (p.element.removeChild(p.foldWidget),
                                    (p.foldWidget = null));
                ...
                r.implement(this, u),
                    ...
                    (this.scrollLines = function (e) {
                        ...
                        if (e.firstRow < t.firstRow) {
                            var i = this.$renderLinesFragment(
                                e,
                                e.firstRow,
                                t.firstRow - 1,
                            );
                    ...
                    (this.update = function (e) {
                        ...
                        for (var n = 0, i = t.length; n < i; n++) {
                            ...
                            if (
                                ...
                                continue;
                            var o = (this.cursors[r++] || this.addCursor())
                                .style;
                            (o.left = s.left + "px"),
                                (o.top = s.top + "px"),
            ...
            (function () {
                (this.CHANGE_CURSOR = 1),
                    ...
                    (this.$moveTextAreaToCursor = function () {
                        ...
                        (n -= this.scrollLeft),
                            ...
                            (this.textarea.style.left =
                                Math.min(n, this.$size.scrollerWidth - i) +
                                "px"),
                    ...
                    (this.getLastFullyVisibleRow = function () {
                        var e = Math.floor(
                            (this.layerConfig.height +
                                this.layerConfig.offset) /
                    ...
                    (this.$computeLayerConfig = function () {
                        ...
                        var e = this.session,
                            ...
                            a =
                                ...
                                (this.$hScrollBarAlwaysVisible ||
                                    t.scrollerWidth - u - 2 * this.$padding <
                                        0),
                        ...
                        var p = Math.ceil(o / this.lineHeight) - 1,
                            d = Math.max(
                                0,
                                Math.round(
                                    (this.scrollTop - s) / this.lineHeight,
                                ),
                            ),
                            v = d + p,
                            m,
                    ...
                    (this.$workerBlob = function (e) {
                        ...
                        try {
                            ...
                            var r =
                                ...
                                s = new r();
                            return (
                                s.append(t), s.getBlob("application/javascript")
                            );
                        }
                    });
            }).call(u.prototype);
