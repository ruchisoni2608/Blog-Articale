                                ...
                                c = (function () {
                                    ...
                                    function ot(t, n) {
                                        ...
                                        !n &&
                                            ...
                                            rt("let"),
                                            rt("("),
                                            f.syntax.let.fud.call(
                                                f.syntax.let.fud,
                                                !1,
                                            ),
                                            rt(")")),
                                            f.tokens.next.id === "(end)" &&
                                                G("E006", f.tokens.curr);
                                        var a =
                                            f.option.asi &&
                                            f.tokens.prev.line <
                                                f.tokens.curr.line &&
                                    ...
                                    function Jt(t, n, i, s) {
                                        var o,
                                            ...
                                            l = D;
                                        return (
                                            (f.option = Object.create(
                                                f.option,
                                            )),
                                            (f.ignored = Object.create(
                                                f.ignored,
                                            )),
                                            (D = Object.create(D)),
                                            (w = $t(
                                        ...
                                        (pt("export", function () {
                                            ...
                                            return (
                                                f.tokens.next.id === "var"
                                                    ? (rt("var"),
                                                      (y[f.tokens.next.value] =
                                                          !0),
                                                      f.syntax["var"].fud.call(
                                                          f.syntax["var"].fud,
                                                      ))
                                                    : f.tokens.next.id === "let"
                                                    ? (rt("let"),
