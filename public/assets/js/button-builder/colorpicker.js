    ...
    var ColorPicker = (function () {
        var ids = {},
            ...
            upIncrement = function (ev) {
                change.apply(ev.data.field.get(0), [true]);
                ev.data.el
                    .removeClass("colorpicker-slider")
                    .find("input")
                    .focus();
                            ...
                            parseInt(
                                (360 *
                                    (150 -
                                        Math.max(
                                            0,
                                            Math.min(150, ev.pageY - ev.data.y),
                                        ))) /
                                    150,
                                10,
                            ),
            ...
            show = function (ev) {
                ...
                if (
                    cal.data("colorpicker").onShow.apply(this, [cal.get(0)]) !=
                    false
                ) {
                    cal.show();
                }
            ...
            init: function (opt) {
                ...
                return this.each(function () {
                    if (!$(this).data("colorpickerId")) {
                        ...
                        options.selectorIndic =
                            options.selector.find("div div");
                        options.el = this;
                        options.hue = cal.find("div.colorpicker-hue div");
                        cal.find("div.colorpicker-hue").bind(
                            "mousedown",
                            downHue,
                        );
                        options.newColor = cal.find(
                            "div.colorpicker-new-color",
                        );
                        options.currentColor = cal.find(
                            "div.colorpicker-current-color",
                        );
