    ...
    if (typeof define === "undefined") {
        ...
        s = g.s = {
            ...
            newContext: function (b) {
                ...
                function d(a) {
                    v &&
                        t(
                            ...
                            function (f) {
                                if (
                                    f.getAttribute("data-requiremodule") ===
                                        a &&
                ...
                function s() {
                    P.length &&
                        (fa.apply(C, [C.length - 1, 0].concat(P)), (P = []));
                }
                function u(a, f, b) {
                    var e = a.map.id;
                    a.error
                ...
                h = {
                    ...
                    onScriptError: function (a) {
                        ...
                        if (!p(b.id))
                            return z(
                                G("scripterror", "Script error", a, [b.id]),
                            );
                    },
                };
        ...
        g.load = function (b, c, d) {
            ...
            if (v)
                return (
                    ...
                    !R
                        ? ((J = !0),
                          i.attachEvent("onreadystatechange", b.onScriptLoad))
