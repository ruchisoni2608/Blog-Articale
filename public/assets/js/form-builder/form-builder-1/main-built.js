...
(function (e, t) {
        ...
        if (ut.acceptData(e)) {
            ...
            if ((c && l[c] && (i || l[c].data)) || !a || r !== t)
                return (
                    ...
                    a
                        ? ((o = s[n]), null == o && (o = s[ut.camelCase(n)]))
                        : (o = s),
                    o
                );
        }
            ...
            (n = e[i]),
                n.style &&
                    ...
                    t
                        ...
                        : r[i] ||
                          S(n) ||
                          ut._data(n, "olddisplay", ut.css(n, "display")));
        for (i = 0; s > i; i++)
            (n = e[i]),
                n.style &&
                    ((t &&
    ...
    function C(e, t, n) {
        var r = !0,
            ...
            o =
                ...
                "border-box" === ut.css(e, "boxSizing", !1, s);
        if (0 >= i || null == i) {
            if (
                ((i = an(e, t, s)),
        ...
        return (
            n ||
                ...
                ("none" !== n && n) ||
                    ...
                    (t = (ln[0].contentWindow || ln[0].contentDocument)
                        .document),
        ...
        n.queue ||
            ...
            1 === e.nodeType &&
                ...
                "inline" === ut.css(e, "display") &&
                    "none" === ut.css(e, "float") &&
                    (ut.support.inlineBlockNeedsLayout &&
                    "inline" !== k(e.nodeName)
                        ? (p.zoom = 1)
    ...
    var X,
        ...
        wt = function () {
            $.addEventListener
                ? ($.removeEventListener("DOMContentLoaded", wt, !1),
                  ut.ready())
                : "complete" === $.readyState &&
                        ...
                        for (n in e)
                            (r = u[n]),
                                ...
                                u !== i &&
                                    (l &&
                                    i &&
                                    (ut.isPlainObject(i) || (s = ut.isArray(i)))
                                        ? (s
                                              ? ((s = !1),
                                                (o =
                                                    r && ut.isArray(r)
        ...
        (ut.support = (function () {
            ...
            for (c in {
                ...
                h.setAttribute((f = "on" + c), "t"),
                    (n[c + "Bubbles"] =
                        f in e || h.attributes[f].expando === !1);
            return (
    ...
    ut.extend({
        ...
        hasData: function (e) {
            return (
                (e = e.nodeType ? ut.cache[e[ut.expando]] : e[ut.expando]),
                !!e && !u(e)
            );
        },
        data: function (e, t, n) {
            ...
            data: function (e, n) {
                ...
                if (e === t) {
                    if (
                        this.length &&
                        ((a = ut.data(s)),
                        1 === s.nodeType && !ut._data(s, "parsedAttrs"))
                    ) {
                        for (r = s.attributes; r.length > u; u++)
                            (i = r[u].name),
                                i.indexOf("data-") ||
                                    ((i = ut.camelCase(i.substring(5))),
                                    o(s, i, a[i]));
        ...
        val: function (e) {
            ...
            if (s)
                return (
                    (n =
                        ut.valHooks[s.type] ||
                        ut.valHooks[s.nodeName.toLowerCase()]),
    ...
    (ut.event = {
                        ...
                        (c = ut.extend(
                            {
                                ...
                                selector: s,
                                needsContext:
                                    s && ut.expr.match.needsContext.test(s),
                                namespace: v.join("."),
                            },
                            o,
                        )),
        ...
        remove: function (e, t, n, r, i) {
            ...
            if (m && (a = m.events)) {
                ...
                ut.isEmptyObject(a) &&
                    (delete m.handle, ut._removeData(e, "events"));
            }
        },
        trigger: function (n, r, i, s) {
            ...
            if (
                ...
                3 !== i.nodeType &&
                    ...
                    (n = n[ut.expando]
                        ? n
                        : new ut.Event(d, "object" == typeof n && n)),
                    (n.isTrigger = !0),
                    (n.namespace = v.join(".")),
                ...
                if (
                    ...
                    !(
                        ...
                        (h._default &&
                            h._default.apply(i.ownerDocument, r) !== !1) ||
                ...
                for (
                    ...
                    for (
                        ...
                        (!e.namespace_re || e.namespace_re.test(o.namespace)) &&
                            ...
                            (e.data = o.data),
                            (i = (
                                (ut.event.special[o.origType] || {}).handle ||
                                o.handler
                            ).apply(s.elem, a)),
                            i !== t &&
                                (e.result = i) === !1 &&
        ...
        special: {
            ...
            blur: {
                trigger: function () {
                    return this === $.activeElement && this.blur
                        ? (this.blur(), !1)
                        : t;
                },
                        ...
                        if ((o = i[1])) {
                            ...
                            if (i[2])
                                return (
                                    G.apply(
                                        n,
                                        Y.call(t.getElementsByTagName(e), 0),
                                    ),
                                    n
                                );
                            if (
                                ...
                                return (
                                    G.apply(
                                        n,
                                        Y.call(t.getElementsByClassName(o), 0),
                                    ),
                                    n
                                );
                        }
                        ...
                        return r !== M && 9 === r.nodeType && r.documentElement
                            ? ((M = r),
                              ...
                              (R.getByName = s(function (e) {
                                  ...
                                  return (
                                      (R.getIdNotName = !r.getElementById(I)),
                                      _.removeChild(e),
                                      t
                                  );
                              })),
    ...
    (sn.optgroup = sn.option),
        ...
        ut.fn.extend({
            ...
            empty: function () {
                for (var e, t = 0; null != (e = this[t]); t++) {
                    for (
                        1 === e.nodeType && ut.cleanData(b(e, !1));
                        e.firstChild;

                    )
                        e.removeChild(e.firstChild);
                    e.options &&
                        ut.nodeName(e, "select") &&
                        (e.options.length = 0);
                }
                return this;
            },
        ...
        ut.each(
            ...
            function (e, t) {
                ut.fn[e] = function (e) {
                    for (
                        var n, r = 0, i = [], s = ut(e), o = s.length - 1;
                        o >= r;
                        r++
                    )
        ...
        ut.extend({
            clone: function (e, t, n) {
                ...
                if (
                    ...
                    !(
                        (ut.support.noCloneEvent &&
                            ut.support.noCloneChecked) ||
    ...
    ut.fn.extend({
        ...
        (ut.param = function (e, n) {
            ...
            if (
                (n === t &&
                    (n = ut.ajaxSettings && ut.ajaxSettings.traditional),
            ...
            ajax: function (e, n) {
                function r(e, n, r, u) {
                    ...
                    2 !== w &&
                        ...
                        (S.statusText = (n || x) + ""),
                        f
                            ? v.resolveWith(p, [c, x, S])
                            : v.rejectWith(p, [S, x, y]),
                        S.statusCode(g),
                        (g = t),
                        l &&
                            d.trigger(f ? "ajaxSuccess" : "ajaxError", [
                                S,
                                h,
                                f ? c : y,
                            ]),
                ...
                (l = h.global),
                    ...
                    h.ifModified &&
                        ...
                        ut.etag[s] &&
                            S.setRequestHeader("If-None-Match", ut.etag[s])),
            ...
            return a || "jsonp" === n.dataTypes[0]
                ? ((s = n.jsonpCallback =
                  ...
                  i.always(function () {
                      (e[s] = o),
                          n[s] &&
                              ((n.jsonpCallback = r.jsonpCallback), Xn.push(s)),
    ...
    function () {
        ...
        s.extend(f.prototype, a, {
            ...
            escape: function (e) {
                ...
                var n = this.get(e);
                return (this._escapedAttributes[e] = s.escape(
                    n == null ? "" : "" + n,
                ));
            },
            has: function (e) {
        ...
        s.each(c, function (e) {
            l.prototype[e] = function () {
                return s[e].apply(
                    s,
                    [this.models].concat(s.toArray(arguments)),
                );
            };
        });
        ...
        (m.started = !1),
            s.extend(m.prototype, a, {
                ...
                navigate: function (e, t) {
                    ...
                    this._hasPushState
                        ? (n.indexOf(this.options.root) != 0 &&
                              (n = this.options.root + n),
                          (this.fragment = n),
                          window.history[
                              t.replace ? "replaceState" : "pushState"
                          ]({}, document.title, n))
                        : this._wantsHashChange
                        ? ((this.fragment = n),
                    ...
                    if (!o || !o.transitioning)
                        f &&
                            f
                                ...
                                .not(n)
                                .addClass("collapsed"),
                            n[s.hasClass("in") ? "addClass" : "removeClass"](
                                "collapsed",
                            );
                    s.collapse(u);
                },
            ...
            (t.prototype.hide = function () {
                ...
                return (
                    ...
                    e.support.transition && this.$tip.hasClass("fade")
                        ? n
                              .one(e.support.transition.end, i)
                              .emulateTransitionEnd(150)
                        : i(),
        ...
        (t.DEFAULTS = e.extend({}, e.fn.tooltip.Constructor.DEFAULTS, {
            ...
            (t.prototype.setContent = function () {
                ...
                e
                    ...
                    e.find(".popover-header").html() ||
                        e.find(".popover-header").hide();
            }),
            (t.prototype.hasContent = function () {
    ...
    +(function (e) {
        ...
        (t.prototype.show = function () {
            ...
            (t.prototype.activate = function (t, n, r) {
                ...
                s
                    ? i
                          .one(e.support.transition.end, o)
                          .emulateTransitionEnd(150)
                    : o(),
                    i.removeClass("in");
            });
        ...
        function (e, t, n, r) {
            return t.extend({
                ...
                render: function () {
                    return this.$el.html(
                        this.tempTemplate({
                            text: this.constructor.__super__.render
                                .call(this)
                                .html(),
                        }),
                    );
                ...
                postRender: function (e) {
                    (this.tempForm = this.$el.find("form")[0]),
                        (this.halfHeight = Math.floor(
                            this.tempForm.clientHeight / 2,
                        )),
                        (this.halfWidth = Math.floor(
                            this.tempForm.clientWidth / 2,
                        )),
                ...
                mouseDownHandler: function (t) {
                    t.preventDefault(),
                        ...
                        e("body").append(
                            new s({
                                model: new r(
                                    e.extend(!0, {}, this.model.attributes),
                                ),
                            }).render(),
                        ),
                    ...
                    t.each(this.collection.renderAll(), function (e) {
                        ...
                        e("#render").val(
                            n.renderForm({
                                text: t
                                    .map(
                                        this.collection.renderAllClean(),
                                        function (e) {
                                            return e.html();
                                        },
                                    )
