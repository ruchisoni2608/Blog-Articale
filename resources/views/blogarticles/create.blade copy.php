...
<style>
    ...
    /* for switch button */
        ...
        .dropzone-previews {
            border: 2px dashed #ccc; /* Add a dashed border to the container */
  ...
  <div class="border p-3">
        ...
        <div class="row">
            ...
            <!-- <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong> Content:</strong>
                  <textarea id="content" name="content" cols="30" rows="10" width="100%"></textarea>
                </div>
            </div> -->
...
@section('scripts')
    ...
    //     // Add an event listener to the form's submit button click event
    //     document.querySelector('form button[type="submit"]').addEventListener('click', updateTextarea);
    // // alert("444");
    // });
    document.addEventListener("DOMContentLoaded", function () {
        CKEDITOR.replace('editor1', {
 ...
 <!-- <script>
       DecoupledEditor
            ...
            .then( editor => {
                ...
                // You can now work with the editor instance
            } )
            .catch( error => {
                console.error( error );
            } );
