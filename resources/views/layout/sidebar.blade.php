            ...
            <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                    ...
                    {{-- <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                            ...
                            </svg><span class="lan-6">My Profile</span></a>
                        <ul class="sidebar-submenu">
                             @php  
                                                          $user = Auth::user();
                                                          @endphp
                            <li><a href="{{ route('profile.show',$user->id)}}">My profile</a></li>
                            <li><a href="{{ route('profile.edit',$user->id)}}">Edit profile</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                        ...
                        <ul class="sidebar-submenu">
                            ...
                            <li><a href="{{ route('faqscategory.index') }}">FAQ Category </a></li>
                    ...
                    <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                        ...
                        <ul class="sidebar-submenu">
                            <li><a href="{{ route('blogcategories.index') }}">Blog Category</a></li>
                            <li><a href="{{ route('blogarticles.index') }}">Blog Article </a></li>
                            {{-- <li><a href="{{route('')}}">Edit Blog</a></li> --}}
                        </ul>
                    </li>
