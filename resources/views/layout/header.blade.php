                                                 ...
                                                 <div class="col-4 text-center">
                                                     <div class="bookmark-content">
                                                         ...
                                                         @php  
                                                          $user = Auth::user();
                                                          @endphp
                                                         <h5 class="mt-2"> <a href="{{ route('profile.show',$user->id) }}">My Profile</a></h5>
                                                     </div>
                                                 </div>
                                                 ...
                                                 {{-- <div class="col-4 text-center">
                                                     <div class="bookmark-content">
                                                         <div class="bookmark-icon"><i data-feather="user"></i>
                                                          ...
                                                          @endphp
                                                         <h5 class="mt-2"> <a
                                                                 href="{{ route('profile.edit',$user->id) }}">Edit
                                                                 Profile</a>
                                                         </h5>
                                                     </div>
                                                 </div> --}}
                                 ...
                                 <div class="media"><img class="img-fluid b-r-5 me-3 img-50"
                                     ...
                                     <div class="media-body">
                                         ...
                                         <div class="cart-quantity"><span class="plus"><i
                                             ...
                                             <input class="count" type="text" name="qty"
                                                 value="3"><span class="minus"><i
